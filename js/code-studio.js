        ...
        setTimeout(() => {
            ...
            if (code.includes('predict_growth')) {
                ...
                output = '<span class="prompt">$ dotnet run</span>\n' +
                    '[C# .NET] Initializing Wad Nooh AAMN Core...\n' +
