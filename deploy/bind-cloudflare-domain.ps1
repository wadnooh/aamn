...
<#
Creates a named Cloudflare tunnel and prints DNS records for 2-aa.com.
...
Write-Host "==> Creating named tunnel 2-aa..." -ForegroundColor Cyan
$create = & $cf tunnel create 2-aa 2>&1 | Out-String
Write-Host $create
...
$configPath = Join-Path $cfgDir "2-aa-config.yml"
@"
tunnel: 2-aa
...
ingress:
  ...
  - hostname: www.2-aa.com
    service: http://127.0.0.1:5162
  - service: http_status:404
"@ | Set-Content -Path $configPath -Encoding UTF8

Write-Host "==> Routing DNS..." -ForegroundColor Cyan
& $cf tunnel route dns 2-aa 2-aa.com
& $cf tunnel route dns 2-aa www.2-aa.com

Write-Host "==> Starting named tunnel service..." -ForegroundColor Cyan
# Run tunnel in background
Start-Process -FilePath $cf -ArgumentList @("tunnel","--config",$configPath,"run","2-aa") -WindowStyle Hidden
...
Write-Host "Then open https://2-aa.com"
